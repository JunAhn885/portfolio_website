    ...
    <div className={styles.content}>
      <div className={styles["main-content"]}>
        <div className={styles["left-content"]}>
          ...
          <h2>
            I am a graduate from the University of Washington with a background
            in Informatics and Economics.
          </h2>
          <h2>
            As an aspiring software engineer, I specialize in Front-end
            development to create functional and reactive websites.
          </h2>
          <h2>
            Outside of work, I love cycling, cooking, and exploring new
            restaurants!
          </h2>
        </div>
      ...
      <div className={styles["main-languages"]}>
        ...
        <h2> React.js, Next.js, JavaScript, TypeScript, Python, CSS, HTML </h2>
      </div>
